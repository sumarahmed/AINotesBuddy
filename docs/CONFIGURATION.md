...
`2026.09.01`; `package.json` represents it as `2026.9.1` for semantic-version
compatibility.
...
| Product version | `2026.09.01` | Website/package `Year.Month.MinorRelease` in `src/runtime-config.js` and `package.json` |
