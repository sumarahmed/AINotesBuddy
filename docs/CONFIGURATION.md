...
`2026.08.17`; `package.json` represents it as `2026.8.17` for semantic-version
compatibility.
...
| Product version | `2026.08.17` | Website/package `Year.Month.MinorRelease` in `src/runtime-config.js` and `package.json` |
| Latest companion version | `2026.08.11` | Public, non-secret value in `src/runtime-config.js` used for existing-user update warnings |
