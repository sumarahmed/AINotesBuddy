...
`2026.08.18`; `package.json` represents it as `2026.8.18` for semantic-version
compatibility.
...
| Product version | `2026.08.18` | Website/package `Year.Month.MinorRelease` in `src/runtime-config.js` and `package.json` |
